                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="p-5">
                                    ...
                                    <form action="<?= route_to('register') ?>" method="post" class="user">
                                        ...
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user <?php if(session('errors.email')) : ?>is-invalid<?php endif ?>" name="email"
                                                placeholder="<?=lang('Auth.email')?>" value="<?= old('email') ?>"><small id="emailHelp" class="form-text text-muted"><?=lang('Auth.weNeverShare')?></small>
                                        </div>
                                    ...
                                    <hr>                                   
                                    <div class="text-center">
                                        <a class="small" href="<?= route_to('login') ?>" </a> <?=lang('Auth.alreadyRegistered')?>><?=lang('Auth.signIn')?></a>
                                    </div>
                                </div>
                            </div>
                        </div>
